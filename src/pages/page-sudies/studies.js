...
const Studies = () => {
  ...
  const schoolHeader = 'Gimnasium 315';
  const schooleInterval = '2004 - 2015';
  const schoolText = 'Studied at the gymnasium with in-depth study of foreign languages, a mathematical class. Graduated with honors.'
    return (
      ...
      <MyTimelineItem side={0} text={schoolText} header={schoolHeader} interval={schooleInterval}>
        <FastfoodIcon />
      </MyTimelineItem>

      <MyTimelineItem side={1} text={schoolText} header={schoolHeader} interval={schooleInterval}>
        <FastfoodIcon />
      </MyTimelineItem>
